...
class UnsupervisedFashionMNISTDataset(FashionMNIST):
    def __init__(self, root=DATA_PATH, train=True, transform=None, download=False):
        super(UnsupervisedFashionMNISTDataset, self).__init__(root,
                                                       train=train,
                                                       transform=transform,
                                                       download=download)
    ...
    def __getitem__(self, index):
        ...
        """
        return super(UnsupervisedFashionMNISTDataset, self).__getitem__(index)[0]
