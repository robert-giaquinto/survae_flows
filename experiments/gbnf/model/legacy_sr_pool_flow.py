...
class LegacySRPoolFlow(ConditionalFlow):
    def __init__(self, data_shape, cond_shape, num_bits,
        ...
        super(LegacySRPoolFlow, self).__init__(base_dist=ConvNormal2d(current_shape), transforms=transforms, context_init=context_init)
